	...
	<div class="container">
		...
		<table class="table text-center">
			...
			<tbody>
				...
				<tr>
					...
					<td><fmt:formatNumber value="0.${candidate}" type="percent" /></td>	
				</tr>
				</c:forEach>
			</tbody>
		</table>
		...
		<table class="table text-center">
			...
			<tbody>
				...
				<tr>
					<fmt:parseDate value="${cardBill.date}" pattern="yyyy-MM-dd" var="StrDate" />
					<td>${cardBill.store }</td>
					<td><fmt:formatNumber value="${cardBill.pay }" type="currency" currencySymbol="$" /></td>
					<td><fmt:formatDate value="${StrDate}" pattern="yyyy년 MM월 dd일"/></td>
